    ...
    return (
      <div className="w-full h-full flex items-center justify-center p-4">
        <div className="w-2/3 h-2/3 flex items-center justify-center relative">
          ...
          <svg className="w-16 h-16 text-red-400 z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4 group">
      <div className="w-2/3 h-2/3 flex items-center justify-center relative">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-red-400 animate-pulse-glow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
