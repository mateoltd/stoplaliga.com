    ...
    <div className="min-h-screen bg-black text-white font-mono">
      ...
      <div className="border-b-4 border-red-500 p-8">
        <div className="flex justify-center items-start gap-4 mb-6">
          <div className="flex-1 min-w-0">
            <h1 className="text-balance text-4xl md:text-6xl font-black uppercase tracking-wider mb-4">
              {dict.timeline.title}
            </h1>
        ...
        <div className="bg-red-900 border-2 border-red-500 p-4 text-red-100 text-balance">
      ...
      <div className="p-4 md:p-8">
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-6 md:left-8 top-0 bottom-0 w-1 bg-red-500"></div>
          ...
          {events.map((eventKey, index) => {
            ...
            return (
              <div 
                ...
                id={eventKey}
                data-event={eventKey}
                className={`relative mb-12 ${isLast ? 'mb-0' : ''} transition-all duration-700 transform ${
                  visibleEvents.has(eventKey) ? 'translate-x-0 opacity-100' : '-translate-x-4 opacity-0'
                }`}
              >
                {/* Timeline dot */}
                <div className={`absolute left-4 md:left-6 top-1 w-5 h-5 bg-red-500 border-4 border-black rounded-full transition-all duration-500 ${
                ...
                <div className="ml-14 md:ml-20">
                  ...
                  {/* Event card */}
                  <div className="bg-gray-900 border-2 border-gray-700 p-4 md:p-6 hover:border-red-500 transition-all duration-200 hover:shadow-lg hover:shadow-red-500/20 group">
                      ...
                      <div className="mt-4">
                          ...
                          <div className="bg-gray-800 border-2 border-red-500 p-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                              <div className="bg-red-900 bg-opacity-30 border border-red-600 p-3">
                                <div className="text-xl md:text-2xl font-bold text-red-400">240M+</div>
                                <div className="text-xs text-gray-300">
                                  {lng === 'es' ? 'Sitios web' : 'Websites'}
                                </div>
                              </div>
                              <div className="bg-red-900 bg-opacity-30 border border-red-600 p-3">
                                <div className="text-xl md:text-2xl font-bold text-red-400">20%</div>
                                <div className="text-xs text-gray-300">
                                  {lng === 'es' ? 'De la web global' : 'Of global web'}
                                </div>
                              </div>
                              <div className="bg-red-900 bg-opacity-30 border border-red-600 p-3">
                                <div className="text-xl md:text-2xl font-bold text-red-400">3M+</div>
                                <div className="text-xs text-gray-300">
                        ...
                        {eventKey === '2025-04-12' && (
                          <div className="bg-gray-800 border-2 border-red-500 p-4">
                            ...
                            <div className="flex items-center justify-center space-x-4 md:space-x-8 mb-3">
                              <div className="text-center">
                                <div className="text-2xl md:text-3xl font-bold text-red-400">9M+</div>
                                <div className="text-xs text-gray-300">
                              ...
                              <div className="text-center">
                                <div className="text-2xl md:text-3xl font-bold text-red-400">DEV</div>
                                <div className="text-xs text-gray-300">
